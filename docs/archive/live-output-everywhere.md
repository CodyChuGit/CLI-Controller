...
CLI Controller IDE should make assistant work feel immediate, readable, and
...
Antigravity, or the controller starts working, CLI Controller should show
...
- **No fake typing**: smoothing improves readability, but CLI Controller should
...
Live output should not turn the UI into raw terminal scrollback. CLI Controller
